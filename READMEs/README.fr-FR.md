...
simplicio-loop a été conçu **après une étude approfondie** du meilleur travail de boucle + économie de
...
> Eux réduisent les tokens ; simplicio-loop **fait le travail** et réduit les tokens en le faisant.
